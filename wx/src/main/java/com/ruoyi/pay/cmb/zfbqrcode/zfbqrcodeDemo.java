package com.ruoyi.pay.cmb.zfbqrcode;
 ...
 * 支付宝native码支付
 */
public class zfbqrcodeDemo {

    //private static final String url = "https://api.cmburl.cn:8065/polypay/v1.0/mchorders/zfbqrcode";
    private static final String url = "http://polypay-api.paasuat.cmbchina.cn/api/zfbqrcode";
