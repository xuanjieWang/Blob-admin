package com.ruoyi.pay.cmb.refundquery;
...
public class refundqueryDemo {
    ...
    private static final String url = "http://polypay-api.paasuat.cmbchina.cn/api/refundquery";
    ...
    private static String signMethod() {
        ...
        try {
            ...
            requestTransactionParams.put("orderId", "1562036392778"); //商户退款订单号，被查询交易的商户退款订单号，此字段和平台退款订单号字段至少要上送一个，若两个都上送，则以平台退款订单号为准
            requestTransactionParams.put("cmbOrderId", "100419070210595371147326"); //平台退款订单号，被查询交易招行退款订单号，此字段和商户退款订单号字段至少要上送一个，若两个都上送，则以此字段为准
