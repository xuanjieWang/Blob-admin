package com.ruoyi.pay.cmb.miniAppOrderApply;
 ...
 * 关闭订单
 */
public class miniAppOrderApplyDemo {
    //private static final String url = "https://api.cmburl.cn:8065/polypay/v1.0/mchorders/close";
