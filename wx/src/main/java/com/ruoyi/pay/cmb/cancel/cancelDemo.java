package com.ruoyi.pay.cmb.cancel;
...
public class cancelDemo {
    ...
    //private static final String url = "https://api.cmburl.cn:8065/polypay/v1.0/mchorders/cancel";
    private static final String url = "http://polypay-api.paasuat.cmbchina.cn/api/cancel";
    ...
    private static String signMethod() {
        ...
        try {
            ...
            requestTransactionParams.put("origOrderId", "1562036392778"); //原交易商户订单号,被撤销交易的商户订单号，此字段和被撤销交易平台订单号字段至少要上送一个，若两个都上送，则以被撤销交易平台订单号为准
            requestTransactionParams.put("origCmbOrderId", "100419070210595371147326");  //原交易平台订单号,被撤销交易招行订单号，此字段和被撤销交易商户订单号字段至少要上送一个，若两个都上送，则以此字段为准
