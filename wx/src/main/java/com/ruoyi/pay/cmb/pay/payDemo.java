...
public class payDemo {
    ...
    //private static final String url = "https://api.cmburl.cn:8065/polypay/v1.0/mchorders/pay";
    private static final String url = "http://polypay-api.paasuat.cmbchina.cn/api/pay";
    ...
    private static String signMethod() {
        ...
        try {
            ...
            requestTransactionParams.put("subAppId", "wxe1de08674c2d8eae");   //子公众号账号ID
            requestTransactionParams.put("orderId", "" + System.currentTimeMillis()); //商户订单号(必传)
            requestTransactionParams.put("authCode", "288731800822702275"); //授权码(必传)
            requestTransactionParams.put("userId", "N002852494");   //收银员（必传）
            requestTransactionParams.put("termId", "00774411");  //终端号（必传）
