package com.ruoyi.pay.cmb.statement;
 ...
 * 支付宝服务窗支付
 */
public class statementUrlDemo {
    //private static final String url = "https://api.cmburl.cn:8065/polypay/v1.0/mchorders/servpay";
    private static final String url = "http://polypay-api.paasuat.cmbchina.cn/api/servpay";
